...
In this post I will be demonstrating how to construct a simple data vizulization of the [Palmer Penguins](https://github.com/allisonhorst/palmerpenguins) data set using Python.
...
![histograms.png](/images/histograms.png)
