...
```
    ...
    <matplotlib.collections.PathCollection at 0x7fc3e8adacd0>
...
```
    ...
    <matplotlib.collections.PathCollection at 0x7fc3e9caf550>
...
```
    ...
    <matplotlib.collections.PathCollection at 0x7fc3e9c36850>
...
```
    ...
    <matplotlib.collections.PathCollection at 0x7fc3e9e46e90>
...
```
    ...
    <matplotlib.collections.PathCollection at 0x7fc3ea07ea10>
...
```
    ...
    <matplotlib.collections.PathCollection at 0x7fc3eb18ae50>
...
```
    ...
    <matplotlib.collections.PathCollection at 0x7fc3eb21f050>
...
```
    ...
    <matplotlib.collections.PathCollection at 0x7fcc6f823950>
...
Great! This is the result we desried.
...
```
    ...
    <matplotlib.collections.PathCollection at 0x7fcc6f7f3890>
...
This generates a result similar to what we saw earlier! Let's try incresing our noise to `noise = 0.25`.
...
```
    ...
    <matplotlib.collections.PathCollection at 0x7fcc6f9a1e50>
...
It appears that as we increase out noise, the data becomes more clustered together, rendering it harder for our model to make a distinction in our data. It still splits our data down the middle, but with grouped-data it is much harder to say whether or not our model is performing well.
...
```
    ...
    <matplotlib.collections.PathCollection at 0x7fcc6caa3a10>
...
```
    ...
    <matplotlib.collections.PathCollection at 0x7fcc6cb18d90>
...
```
    ...
    <matplotlib.collections.PathCollection at 0x7fcc6ce65e90>
...
Clearly the model considered the entire data as one label. Let's increae our epsilon to 0.3.
...
```
    ...
    <matplotlib.collections.PathCollection at 0x7fcc6cefbf50>
...
This is perfect! The bullseye data is partitioned so that the outer circle and inner circle have different colors. In this way we see that by adjusting our distance threshold `epsilon` we can cluster different shapes of data.
